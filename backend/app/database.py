...
def seed_demo_data():
    """
    Cipta pengguna demo supaya feed dan chat boleh berfungsi.
    Data ini SEPADAN dengan MOCK_F dan MOCK_M dalam frontend (baris 759-791).
    """
    db = SessionLocal()
    try:
        ...
        demos = [
            # ═══ PEREMPUAN (MOCK_F baris 759-774) ═══
