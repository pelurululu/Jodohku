...
function psyCalcResult() {
  ...
  // Wire to backend — submit results for CRM + matchmaking consistency
  apiCall('POST', '/psych/submit-results', {
    user_uid: S.uid,
    answers: psyAns,
    psy_score: finScore,
    psy_type: ptype,
    ...
    psy_traits: traits,
    psy_dims: avgDims,
    psy_custom_text: S.psyCustomText || '',
  }).catch(() => {}); // Fire-and-forget; UI tidak tunggu
}
